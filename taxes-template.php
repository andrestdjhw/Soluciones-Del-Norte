...
<section class="sdn-surface sdn-surface--video text-paper border-b border-paper/15">
  ...
  <div class="sdn-layer mx-auto max-w-[1200px] px-6 pb-16 pt-16 lg:px-12 lg:pb-20 lg:pt-24">
    <div data-reveal>
      ...
      <p data-i18n="svc.taxes.deck" class="sdn-measure mt-8 text-[1.125rem] leading-[1.65] text-rule">
  ...
  <div class="sdn-layer grid lg:grid-cols-2 lg:items-stretch">
    ...
    <div class="px-6 py-16 lg:flex lg:flex-col lg:justify-center lg:px-16 lg:py-16 xl:px-20">
      <div data-reveal>
        ...
        <h2 data-i18n="svc.taxes.faq_h2" class="mt-4 font-display text-[1.75rem] font-semibold leading-[1.15] text-ink sm:text-[2.25rem]">
          <?php echo esc_html( $c['faq_h2'] ); ?>
        </h2>
        <p data-i18n="svc.taxes.faq_note" class="sdn-measure-sm mt-5 text-[0.9375rem] leading-relaxed text-muted">
        ...
        <?php foreach ( $c['faqs'] as $i => $faq ) : ?>
          <details class="sdn-faq group border-b border-rule <?php echo 0 === $i ? 'border-t' : ''; ?>">
            <summary class="flex cursor-pointer items-start justify-between gap-6 py-5">
              <span data-i18n="svc.taxes.faq.<?php echo esc_attr( $i ); ?>.q" class="sdn-measure-sm font-display text-[1.0625rem] font-semibold leading-snug text-ink transition-colors duration-150 group-hover:text-accent-2">
            ...
            <p data-i18n="svc.taxes.faq.<?php echo esc_attr( $i ); ?>.a" class="sdn-measure-sm pb-6 text-[1.0625rem] leading-[1.65] text-ink-2">
